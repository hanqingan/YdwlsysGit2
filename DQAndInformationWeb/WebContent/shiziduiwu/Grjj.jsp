...
<script>
	(function() {
		var oList = document.querySelectorAll('.list_2 h2'), oHide = document
				.querySelectorAll('.hide_2'), oIcon = document
				.querySelectorAll('.list_2 i'), lastIndex = 0;
...
<body>
		...
		<div class="nav_2">
			<ul>
				<li class="list_2" style="list-style: none;">
					<h2>
						<i></i><a href="zaizhijiaoshi/zaizhijiaoshi.html"
							style="text-decoration: none;">在职教师</a>
					</h2>
					<div class="hide_2">
						<h5>
							<a href="zaizhijiaoshi/zaizhijiaoshi.html"
								style="text-decoration: none;">按拼音排序</a>
						</h5>
						<h5>
							<a href="zaizhijiaoshi/zzjszy.html"
								style="text-decoration: none;">按专业排序</a>
						</h5>
						<h5>
							<a href="zaizhijiaoshi/zzjszc.html"
								style="text-decoration: none;">按职称排序</a>
						</h5>
					</div>
				</li>
				<li class="list_2" style="list-style: none;">
					<h2>
						<i></i><a href="rencaijihua/rencaijihua.html"
							style="text-decoration: none;">人才计划</a>
					</h2>
				</li>
				<li class="list_2" style="list-style: none;">
					<h2>
						<i></i> <a href="jiaoxuemingshi/jiaoxuemingshi.html"
							style="text-decoration: none;">教学名师</a>
					</h2>
				</li>
				<li class="list_2" style="list-style: none;">
					<h2>
						<i></i> <a href="jianzhijiaoshi/jianzhijiaoshi.html"
							style="text-decoration: none;">兼职教师</a>
					</h2>
				</li>
			</ul>
		</div>
	...
	<div>
		<c:forEach items="${list}" var="t">
			...
			<div class="w3ls_order w3ls_order2">${t.getName()}</div>
