...
<head>
    ...
    <link href="css/zuzhi.css" rel='stylesheet' type='text/css' />
...
-->
    ...
    <link rel="stylesheet" href="css/xianrenlingdao.css"> <!-- Resource style -->
...
<div class="header-home">
    <div class="fixed-header">
        ...
        <div class="top-nav">
            ...
            <ul >
                <li class="active"><a href="xygk.html">学院概括</a></li>
...
<div class="mue" id="container" style = "position:fixed;left:5px;top:430px;font-size: 20px;line-height: 30px;">

        <a href="javascript:" ; onclick="dianji1()">院长致辞</a>
        <a href="javascript:" ; onclick="dianji2()">学院简介</a>
        <a href="javascript:" ; onclick="dianji3()">现任领导</a>
        <a href="javascript:" ; onclick="dianji4()">办学特色</a>
        <a href="javascript:" ; onclick="dianji5()">历史沿革</a>
        <a href="javascript:" ; onclick="dianji6()">组织结构</a>
...
<div class="grid_1" id="geshi1" style="display: block;">
    <div class="container">
        ...
        <div class="box_20">
            <div class="col-sm-6 box_3"><img src="images/xueyuangaikuang/yuanzhang.jpg" class="img-responsive" alt="" /></div>
...
<div class="grid_1" id="geshi2" style="display: none;">
    <div class="container">
        ...
        <div class="box_20">
            <div class="col-sm-6 box_3"><img src="images/xueyuangaikuang/xueyuan.jpg" class="img-responsive" alt="" /></div>
            <div class="col-sm-6 box_3">
...
<div class="grid_3" id="geshi3" style="display: none;">
    ...
    <ul class="cd-items cd-container">
        <li class="cd-item">
            <img src="images/xueyuangaikuang/imgtangyou.jpg" alt="Item Preview">
            <a href="#0" class="cd-trigger" onclick="hahaha1()"></a>
        </li> <!-- cd-item -->

        <li class="cd-item">
            <img src="images/xueyuangaikuang/imgchenkaifeng.jpg" alt="Item Preview">
            <a href="#0" class="cd-trigger" onclick="hahaha2()"></a>
        </li> <!-- cd-item -->

        <li class="cd-item">
            <img src="images/xueyuangaikuang/imghanyu.jpg" alt="Item Preview">
            <a href="#0" class="cd-trigger" onclick="hahaha3()"></a>
        </li> <!-- cd-item -->

        <li class="cd-item">
            <img src="images/xueyuangaikuang/imghoufangbo.jpg" alt="Item Preview">
            <a href="#0" class="cd-trigger" onclick="hahaha4()"></a>
        </li> <!-- cd-item -->

        <li class="cd-item">
            <img src="images/xueyuangaikuang/imgmamingtao2.jpg" alt="Item Preview">
            <a href="#0" class="cd-trigger" onclick="hahaha5()"></a>
        </li> <!-- cd-item -->
    </ul> <!-- cd-items -->
    <div class="cd-quick-view">
        <div class="cd-slider-wrapper">
            <ul class="cd-slider">
                <li class="selected"><img src="images/xueyuangaikuang/imgtangyou.jpg" alt="Product 1"></li>
                <li><img src="images/xueyuangaikuang/imgchenkaifeng.jpg" alt="Product 2"></li>
                <li><img src="images/xueyuangaikuang/imghanyu.jpg" alt="Product 3"></li>
                <li><img src="images/xueyuangaikuang/imghoufangbo.jpg" alt="Product 3"></li>
                <li><img src="images/xueyuangaikuang/imgmamingtao2.jpg" alt="Product 3"></li>
            </ul> <!-- cd-slider -->
        ...
        <c:forEach items="${list}" var="item" begin="1" end="1">
					<p class="description" align="left">
							姓名：<td>${item.name}</td>
						<br>职务：<td>${item.job}</td>
						<br>研究成果：<td>${item.resume}</td>
						<br>涉及领域：<td>${item.education}</td>
						<br>研究方向：<td>${item.honors}</td>
					</p>
					</c:forEach>
		</div>
		<div id="xianrenlingdao2">
		<c:forEach items="${list}" var="item" begin="2" end="2">
					<p class="description" align="left">姓名：<td>${item.name}</td>
					<br>职务：<td>${item.job}</td>
						<br>任职履历：<td>${item.resume}</td>
						<br>教育背景：<td>${item.education}</td>
						<br>所获荣誉：<td>${item.honors}</td>
					</c:forEach>
		</div>
...
<div class="grid_1" id="geshi4" style="display: none;">
    <div class="container">
        ...
        <div class="box_20">
            <div class="col-sm-6 box_3"><img src="images/xueyuangaikuang/wenzi.png" class="img-responsive" alt="" /></div>
            <div class="col-sm-6 box_3">
        ...
        <div class="box_20">
            <div class="box_3">
                <p class="a">学院坚持以“基础知识扎实、实践技能过硬、素质全面发展”为教育目标，所培养学生在社会上赢得了良好的社会声誉，学院将进一步探索新型人才培养模式，注重高素质人才培养，争取为社会和谐、快速发展而努力。</p>
...
<div class="container">
    <div class="box_1">
       <div id="geshi5" style="display: none;">
        ...
        <div class="grid_1" id="geshi6" style="display: none;">
            <div class="container">
                <div class="box_1">
                    <h3>组 织 结 构</h3>
                </div>
                            ...
                            <figure class="org-chart cf">
                                <div class="board ">
                                    ...
                                    <ul class="columnOne">
                                        <li>
													<span class="lvl-b">
														<strong>电气与信息工程学院</strong>
														<br><img src="images/xueyuangaikuang/z1.png" /><img src="images/xueyuangaikuang/z2.png" />
														<br>
													</span>
                                        </li>
                                    </ul>
                                ...
                                <ul class="departments ">
                                    ...
                                    <li class="department ">
												<span class="lvl-b">
													<strong>教学部门</strong>
													<br><img src="images/xueyuangaikuang/z4.png" />

												</span>
                                        <ul class="sections">
                                            <li class="section"> <span>
															<strong>计算机科学与技术系</strong>
															<br><img src="images/xueyuangaikuang/z5.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>电子信息科学与技术系</strong>
															<br><img src="images/xueyuangaikuang/z6.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>网络工程系</strong>
															<br><img src="images/xueyuangaikuang/z7.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>电气工程及其自动化系</strong>
															<br><img src="images/xueyuangaikuang/z8.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>软件工程系</strong>
															<br><img src="images/xueyuangaikuang/z9.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>通信工程教研室</strong>
															<br><img src="images/xueyuangaikuang/z10.png" />
														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>计算机公共教研室</strong>
															<br><img src="images/xueyuangaikuang/z11.png" />
                                    ...
                                    <li class="department ">
												<span class="lvl-b">
													<strong>科研、实验中心</strong>
													<br><img src="images/xueyuangaikuang/z12.png" />

												</span>
                                        <ul class="sections">
                                            <li class="section"> <span>
															<strong>信息技术类实验室</strong>
															<br><img src="images/xueyuangaikuang/z13.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>电子电气类实验室</strong>
															<br><img src="images/xueyuangaikuang/z14.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>ICT实训中心</strong>
															<br><img src="images/xueyuangaikuang/z15.png" />
															<br>
														</span>
                                            </li>
                                        </ul>
                                    ...
                                    <li class="department central">
                                        ...
                                        <ul class="sections">
                                            <li class="section"> <span>
															<strong>工会</strong>
															<br><img src="images/xueyuangaikuang/z16.png" />

														</span>
                                            </li>
                                            <li class="section"> <span>
															<strong>青年教师联合会</strong>
															<br><img src="images/xueyuangaikuang/z17.png" />
                                            ...
                                            <li class="section"> <span>
															<strong>分团委、辅导班</strong>
															<br><img src="images/xueyuangaikuang/z18.png" />
                                    ...
                                    <li class="department ">
                                        ...
                                        <ul class="sections">
                                            <li class="section"> <span>
															<strong>学院办公室</strong>
															<br><img src="images/xueyuangaikuang/z3.png" />
