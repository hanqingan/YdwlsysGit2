...
<div class="container-fluid">
		...
		<div style="margin-top: 0px; height:400px; text-align: center; ">
			<img src="images/dang.png" style="height: 400px;width: 95%; margin: 0 20px 0 1px;"/>
		</div>
		<!-- footer -->
			...
			<div class="container">
				<div class="footer_top">
					<div class="col-sm-3" style="padding-top: 30px;">
							<div style="height: 150px; width: 150px; border-radius: 100px;"><img src="images/院徽.png"></div>
					</div>
					<div class="col-sm-3" style="padding-top: 30px;">
						<ul class="list1">
							<h3>关于本站</h3>
