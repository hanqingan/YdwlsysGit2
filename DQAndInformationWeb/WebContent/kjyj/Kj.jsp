...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="li">
			<br /><br /><br /><br /><br />
			<h4>
				<li><a href="/DQAndInformationWeb/kjyj/index.jsp">首页</a></li>
			</h4>
			<br /><br /><br /><br /><br /><br />
			<h1><a href="/DQAndInformationWeb/kj?method=findAll&cid=1">科教动态</a></h1>
			<br /><br /><br /><br /><br /><br />
			<h4>
		...
		<div class="tab" align="center">
			...
			<table  border="0" cellspacing="" cellpadding="" align="center" class="table">
				...
				<tr align="center" class="s">
					<td align="center">${t.getTestname()}&nbsp;</td>
					
				</tr>
				<tr>
					<td align="center"> ${t.getVtime()}&nbsp;</td>
					
				</tr>
				<tr>
					<td>&nbsp&nbsp&nbsp&nbsp${t.getArtical()}&nbsp;</td>
