...
<body>
		...
		<table id="zsjy_list"></table>  
		<div id="zsjy_dialog"></div>
		
		<script>
			$('#zsjy_list').datagrid
			({    
			    url:'${pageContext.request.contextPath}/back?method=ZsfindAll',     // 要访问的serrvlet的地址  返回的是json数据
			    ...
			    [[  
			      	...
			      	*/
			        {field:'vid',title:'文章编号',width:70},    
			        {field:'vtest_name',title:'文章名称',width:500}, 
			        {field:'vtest_teacher',title:'教师名称',width:100}, 
